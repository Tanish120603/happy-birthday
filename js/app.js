  ...
  BIRTHDAY_CONFIG.friends.forEach((friend) => {
    ...
    card.innerHTML = `
      ...
      <div class="video-info">
        ...
        <button class="card-candle-btn compact ${inCart ? "added" : ""}" onclick="event.stopPropagation(); addCandle(${friend.id})" data-friend-id="${friend.id}" ${inCart ? "disabled" : ""}>
      ...
      <div class="detail-layout">
        ...
        <div class="detail-info">
          ...
          <div class="detail-rating">
            <span class="star">★</span> ${friend.rating}
          </div>
          ...
          <div class="detail-divider"></div>
          <div class="detail-wish-section">
            <div class="detail-wish-title">BIRTHDAY WISH FROM ${friend.name.toUpperCase()}</div>
            <p class="detail-description">This special wish was made just for your birthday. Watch the video message and enjoy the memories! 🧁🎉</p>
          </div>
        </div>
      </div>
    </div>
